...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ---- STATS ---- */}
      <section className="max-w-5xl mx-auto px-4 -mt-16 mb-20 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((stat) => (
            <div key={stat.label} className="bg-white border border-surface-border rounded-2xl p-6 text-center shadow-card animate-fade-in">
